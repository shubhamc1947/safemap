...
<p align="center">
  <img src="https://raw.githubusercontent.com/shubhamc1947/safemap/main/issue.png" width="100%" />
</p>
...
<table align="center" width="100%">
  <tr>
    ...
    <th align="center">Solution – Step 1</th>
  </tr>
  <tr>
    <td align="center">
      <img src="issue.png" width="100%">
    </td>
    <td align="center">
      <img src="solution1.png" width="100%">
    </td>
  </tr>

  <tr>
    <th align="center">Solution – Step 2</th>
    <th align="center">Architecture</th>
  </tr>
  <tr>
    <td align="center">
      <img src="solution2.png" width="100%">
    </td>
    <td align="center">
      <img src="solution-arch.png" width="100%">
    </td>
  </tr>

  <tr>
    <th colspan="2" align="center">Inspiration</th>
  </tr>
  <tr>
    <td colspan="2" align="center">
      <img src="inspiration.png" width="70%">
    </td>
  </tr>
</table>
...
```
ConcurrentMap
├── buckets[0] → { RWMutex, map }
├── buckets[1] → { RWMutex, map }
├── ...
└── buckets[N]
```
...
.
├── cmd/
│   ├── kv-server/           # Main Key-Value HTTP server
│   │   └── main.go
│   └── benchmark/           # Load testing / RPS tool
│       └── main.go
├── pkg/
│   └── concurrentmap/       # Sharded map implementation
│       ├── concurrent_map.go
│       ├── counter_map.go
│       ├── range.go
│       └── atomic_ops.go
...
Failed:           0
-------------------------------
🚀 Requests/Sec:  4306.64
-------------------------------
---
## Benchmark Testing Video

Here’s a **live screen recording** of the benchmark test in action:

 **Watch Video:**
https://drive.google.com/file/d/1vAYYaWCKmustTKAU6_nF2mpaMzIwZ-8w/view?usp=sharing
...
The goal is to keep persistence **optional**, keeping the KV server a drop-in in-memory cache when durability isn’t needed.
